...
class metricor:
    ...
    # def range_convers_all(self, label):
    #     '''
    #     input: arrays of binary values 
    #     output: list of ordered pair [[a0,b0], [a1,b1]... ] of the inputs
    #     '''
    ...
    # def scale_contamination(self, score, contamination):
    ...
    #         # preds[score >= 0.5] = 1
    #         preds[score > (np.mean(score)+3*np.std(score))] = 1
    #         Precision, Recall, F2, Support = metrics.precision_recall_fscore_support(label, preds, zero_division=0)
    #         precision = Precision[1]
    #         recall = Recall[1]
    #         f2 = F2[1]
